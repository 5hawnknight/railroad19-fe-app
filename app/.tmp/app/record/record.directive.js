...
angular.module('projectDashboardApp').directive('record', function () {
    return {
        ...
        link: function link(scope, element, attributes, $mdToast) {
            scope.changeOwner;
            scope.changeStatus;
            scope.adjustBudget;
            scope.searchFilters = '';
            ...
            scope.$watch('filter', function (newValue, oldValue) {
                if (newValue) scope.searchFilters = angular.copy(scope.filter);
            }, true);
...
//# sourceMappingURL=record.directive.js.map
